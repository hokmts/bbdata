---
title: "2022年 埼玉西武ライオンズ 平良海馬 (公式戦)"
author: "hokmts works"
output: 
...
rownames(prslt3) <- c("120km台","130km台","140km台","150km台","160km台","NA")
...
prslt6 <- table(pitch_wk01$球速帯,pitch_wk01$結果2) %>% 
  ...
  dplyr::select(.,単打,長打,本塁打,空振り,見逃し,内野ゴ,内野直,内野飛,外野飛,ファウル,ボール,
                everything()) 
rownames(prslt6) <- c("120km台","130km台","140km台","150km台","160km台","NA")
...
prslt7 <- table(pitch_wk04$球速帯,pitch_wk04$結果2) %>% 
  ...
  dplyr::select(.,単打,長打,本塁打,空三振,見三振,内野ゴ,内野直,内野飛,外野飛,四球,
                everything()) 
rownames(prslt7) <- c("130km台","140km台","150km台","160km台","NA")
